...
public class ConcurrentSkipListMapTest {
	public static void main(String... args) {
		...
		ConcurrentSkipListMap ob = new ConcurrentSkipListMap();
		ob.put("3", "A");
		ob.put("2", "B");
		ob.put("1", "C");
		ob.put("5", "D");
		ob.put("4", "E");
		// returns a key-value mapping of the least value but greater than the
		// given key.
		System.out.println("ceinling entry of 4: " + ob.ceilingEntry("1"));
		
		System.out.println("Submap: " + ob.subMap("2", "4"));
